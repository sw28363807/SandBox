    ...
    onStart() {        
        ...
        this.yesBtn.on(Laya.Event.CLICK, this, function () {
            ...
            if (hasGold >= teacherMeta.costGold) {
                ...
                this.buildingScript.setTeacherIndex(this.selectTeacherIndex);
                this.refreshTeacher();
            } else {
        ...
        this.teacherIndex = this.buildingScript.getTeacherIndex();
        this.selectTeacherIndex = this.buildingScript.getTeacherIndex();
